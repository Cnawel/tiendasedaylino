...
/**
 * NOTA: Las siguientes funciones han sido movidas a common_js_functions.php:
 * - confirmLogout() - usar función de common_js_functions.php
 * - togglePasswordStaff() - usar alias en common_js_functions.php o togglePassword() directamente
 * - validarCoincidenciaPasswordStaff() - usar alias en common_js_functions.php
 * 
 * Estas funciones se mantienen aquí solo como referencia para compatibilidad.
 * Asegúrate de incluir common_js_functions.php antes de este archivo.
 */

/**
 * NOTA: validateEmail() está disponible en common_js_functions.php
 * Se incluye globalmente en footer.php, usar directamente window.validateEmail() o validateEmail()
 */
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (formStaff) {
        formStaff.addEventListener('submit', function(e) {
            ...
            if (!isValid) {
                e.preventDefault();
                const firstError = formStaff.querySelector('.is-invalid');
                if (firstError) {
