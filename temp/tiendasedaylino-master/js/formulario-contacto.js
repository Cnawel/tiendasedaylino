...
(function() {
     ...
     * 
     * Uso: mostrarErrorCampo(campo, null, mensaje) - null para crear dinámicamente
     *      limpiarErrorCampo(campo, null) - null para buscar automáticamente
     */
    ...
    function validarFormulario() {
        ...
        if (!nameInput.checkValidity()) {
            ...
            mostrarErrorCampo(nameInput, null, mensaje);
            esValido = false;
        } else if (nombreValor.length < 4) {
            // Validación JavaScript personalizada (mínimo 4 letras)
            mostrarErrorCampo(nameInput, null, 'El nombre debe tener al menos 4 letras');
            esValido = false;
        }
        ...
        if (!asuntoSelect.checkValidity() || !asuntoSelect.value) {
            ...
            mostrarErrorCampo(asuntoSelect, null, 'Por favor, seleccioná un Asunto');
            esValido = false;
        }
        ...
        if (!messageTextarea.checkValidity() || mensajeValor.length < 20) {
            ...
            mostrarErrorCampo(messageTextarea, null, 'Por favor, contános un poco más del tema para poder ayudarte mejor. (20 caracteres mínimo)');
            esValido = false;
        }
