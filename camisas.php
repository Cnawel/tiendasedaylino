<?php
/**
 * CAMISAS - SISTEMA E-COMMERCE SEDA Y LINO
 * ========================================
 * 
 * Página dinámica que muestra todas las camisas disponibles
...
// ============================================================================
// CONSULTA DE PRODUCTOS DE CAMISAS
// ============================================================================
...
<head>
    ...
    <title>Camisas - Seda y Lino</title>
                ...
                <div class="row align-items-center min-vh-50">
                    <div class="col-lg-6">
                        ...
                        <p class="lead text-white mb-4">
                            Descubre nuestra colección de camisas de lino de alta calidad, 
                    ...
                    <div class="col-lg-6 text-center">
                        <img src="imagenes/productos/camisas/camisa_grupal.png" 
                             alt="Camisas de Lino" 
        ...
        <div class="container py-5">
            <div class="row mb-5 reveal">
                <div class="col-12 text-center">
                    ...
                    <p class="descripcion-productos">Camisas elegantes para hombre y mujer</p>
                ...
                <div class="row">
                    <div class="col-12 text-center">
                        <div class="alert alert-info" role="alert">
                            ...
                            <h4>Próximamente</h4>
                            <p>Estamos trabajando en traerte las mejores camisas de lino.</p>
                        </div>
                    </div>
                </div>
            <?php else: ?>
