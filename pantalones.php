<?php
/**
 * PANTALONES - SISTEMA E-COMMERCE SEDA Y LINO
 * ===========================================
 * 
 * Página dinámica que muestra todos los pantalones disponibles
...
// ============================================================================
// CONSULTA DE PRODUCTOS DE PANTALONES
// ============================================================================
...
<head>
    ...
    <title>Pantalones - Seda y Lino</title>
                ...
                <div class="row align-items-center min-vh-50">
                    <div class="col-lg-6">
                        ...
                        <p class="lead text-white mb-4">
                            Descubre nuestra colección de pantalones de lino de alta calidad, 
                            perfectos para cualquier ocasión. Elegancia y comodidad en cada prenda.
                        </p>
                        <div class="d-flex gap-3">
                            <span class="badge bg-light text-dark fs-6 px-3 py-2">
                                <i class="fas fa-leaf me-2"></i>100% Lino Natural
                            </span>
                            <span class="badge bg-light text-dark fs-6 px-3 py-2">
                    ...
                    <div class="col-lg-6 text-center">
                        <img src="imagenes/productos/pantalones/pantalon_grupal.png" 
                             alt="Pantalones de Lino" 
        ...
        <div class="container py-5">
            <div class="row mb-5 reveal">
                <div class="col-12 text-center">
                    ...
                    <p class="descripcion-productos">Pantalones elegantes para hombre y mujer</p>
                ...
                <div class="row">
                    <div class="col-12 text-center">
                        <div class="alert alert-info" role="alert">
                            ...
                            <h4>Próximamente</h4>
                            <p>Estamos trabajando en traerte los mejores pantalones de lino.</p>
                        </div>
                    </div>
                </div>
            <?php else: ?>
                ...
                <div class="row text-center">
                    <div class="col-md-4 mb-4 reveal">
                        <div class="caracteristica-item">
                            ...
                            <h5>100% Natural</h5>
                            <p class="text-muted">Lino de la más alta calidad, transpirable y ecológico</p>
                        </div>
                    </div>
