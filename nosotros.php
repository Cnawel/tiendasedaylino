 ...
 * ========================================================================
 * Presenta información sobre la tienda, valores y filosofía
 * 
...
<head>
    ...
    <title>Nosotros | Seda y Lino</title>
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                    <ul class="navbar-nav lista-nav">
                        ...
                        <li class="nav-item">
                          <a class="nav-link link-tienda" aria-current="page" href="nosotros.php">NOSOTROS</a>
                        </li>
                        <li class="nav-item">
