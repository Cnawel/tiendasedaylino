<?php
/**
 * SHORTS - SISTEMA E-COMMERCE SEDA Y LINO
 * =======================================
 * 
 * Página dinámica que muestra todos los shorts disponibles
...
// ============================================================================
// CONSULTA DE PRODUCTOS DE SHORTS
// ============================================================================
...
<head>
    ...
    <title>Shorts - Seda y Lino</title>
                ...
                <div class="row align-items-center min-vh-50">
                    <div class="col-lg-6">
                        ...
                        <p class="lead text-white mb-4">
                            Descubre nuestra colección de shorts de lino de alta calidad, 
                            perfectos para el verano. Elegancia y comodidad en cada prenda.
                        </p>
        ...
        <div class="container py-5">
            <div class="row mb-5 reveal">
                <div class="col-12 text-center">
                    ...
                    <p class="descripcion-productos">Shorts elegantes para hombre y mujer</p>
                ...
                <div class="row">
                    <div class="col-12 text-center">
                        <div class="alert alert-info" role="alert">
                            ...
                            <h4>Próximamente</h4>
                            <p>Estamos trabajando en traerte los mejores shorts de lino.</p>
                        </div>
                    </div>
                </div>
            <?php else: ?>
