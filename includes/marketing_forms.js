 ...
 * @param {HTMLElement} errorElement - Elemento donde mostrar el mensaje de error
 * @param {string} mensaje - Mensaje de error
 */
function mostrarErrorCampo(campo, errorElement, mensaje) {
 ...
 * @param {HTMLElement} errorElement - Elemento donde limpiar el mensaje
 */
function limpiarErrorCampo(campo, errorElement) {
    ...
    if (formCrearProducto) {
        ...
        formCrearProducto.addEventListener('submit', function(e) {
            ...
            if (hayErrores) {
                ...
                const primerError = formCrearProducto.querySelector('.is-invalid');
                if (primerError) {
